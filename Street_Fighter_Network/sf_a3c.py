import sys
sys.path.append('/Users/forest/HonorsThesis/sf_implementation/')
sys.path.append('/Users/forest/HonorsThesis/A3C/')
...
for t_thread in training_threads:
  ...
  if len(avg_data) == 0:
    for i in range(len(d)):
      avg_data.append(d[i]/PARALLEL_SIZE)
  else:
    for i in range(len(d)):
      avg_data[i]+=(d[i]/PARALLEL_SIZE)
